...
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '../../components/accommodation_ui/dialog';
...
export default function AccommodationRegister() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    if (name === 'price' || name === 'originalPrice') {
      ...
      if (price && originalPrice && originalPrice > price) {
        ...
        setFormData((prev: typeof formData) => ({ ...prev, discountRate: discount.toString() }));
      } else {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Validation
    if (!formData.name || !formData.category || !formData.address || !formData.price) {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">숙소 정보를 입력해주세요</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Card className="p-6">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500">숙소의 기본 정보를 입력해주세요</p>
            </div>
            <div className="space-y-5">
              ...
              <div>
                <Label htmlFor="category">숙소 유형 *</Label>
              ...
              <div>
                ...
                <Textarea
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">최소 50자 이상 작성해주세요</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500">1박 기준 가격을 입력해주세요</p>
            </div>
          ...
          <Card className="p-6">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500">객실의 상세 정보를 입력해주세요</p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div>
                <Label htmlFor="maxGuests">최대 인원 *</Label>
                <Select value={formData.maxGuests} onValueChange={(value: string) => handleSelectChange('maxGuests', value)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div>
                ...
                <Select value={formData.bedrooms} onValueChange={(value: string) => handleSelectChange('bedrooms', value)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div>
                ...
                <Select value={formData.bathrooms} onValueChange={(value: string) => handleSelectChange('bathrooms', value)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <div className="mt-4">
              <Label htmlFor="size">객실 크기 (㎡)</Label>
              <Input
                id="size"
                name="size"
                type="number"
          ...
          <Card className="p-6">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500">제공되는 편의시설을 선택해주세요</p>
            </div>
          ...
          <Card className="p-6">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500">최소 1장 이상의 이미지를 등록해주세요 (최대 10장)</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              {images.length > 0 && (
                <div>
                  <p className="text-sm text-gray-600 mb-3">등록된 이미지 ({images.length}개)</p>
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                      ...
                      >
                        ...
                        {index === 0 && (
                          <div className="absolute top-2 left-2">
                            <Badge className="bg-blue-600 text-white">대표</Badge>
                          </div>
                        )}
